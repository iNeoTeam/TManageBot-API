...
$parameters = http_build_query(array(
	'action' => "login", // Don't change it.
	'auth' => "@YOUR-ACCESS-KEY", // Replace your HTTP-ACCESS-KEY.
	'phone' => "YOUR-PHONE-NUMBER", // Replace your phone number. ex: 989012345678
	'hash' => "YOUR-LOGIN-RANDOM-HASH", // Replace your login random hash.
	'password' => "ACCOUNT-LOGIN-PASSWORD" // Copy your login password from telegram and replace.
));
